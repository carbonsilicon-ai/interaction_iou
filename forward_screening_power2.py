...
def usage():
	...
	parser.add_argument('-c', '--coreset', default='/mnt/d/data/CASF-2016/CASF-2016/power_screening/CoreSet.dat',
						help="specify the location of 'CoreSet.dat' (or a subset data file) in the CASF-2016 package")
	parser.add_argument('-s', '--scoredir', default='/mnt/d/data/CASF-2016/CASF-2016/000_iou/Affinity-dG@MOE',
	...
	parser.add_argument('-o', '--output', default='IOU-Score',
						help="input the prefix of output result files. Default is My_Docking_Power")													
	parser.add_argument('-t', '--targetfile', default='/mnt/d/data/CASF-2016/CASF-2016/power_screening/TargetInfo.dat',
